...
# Las claves son el 'nombre' del arma en datos.ARMAS. 'Dagas' se mantiene por
# si el arma vuelve a la lista; el hacha reutiliza el sonido de las dagas
# (dagger_attack) porque no hay un clip propio para ella.
SFX_ARMAS = {
    "Espada": "sword_attack",
